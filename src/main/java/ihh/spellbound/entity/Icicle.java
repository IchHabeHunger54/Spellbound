...
public class Icicle extends SpellProjectile {
    ...
    protected void affectBlock(BlockHitResult result) {
        for (BlockPos pos : Util.getBlocksInRange(level, result.getBlockPos().getX(), result.getBlockPos().getY(), result.getBlockPos().getZ(), Config.ICICLE_RANGE.get(), Blocks.AIR)) {
