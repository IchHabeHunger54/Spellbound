...
public final class Config {
    ...
    public static final ForgeConfigSpec.IntValue ADVANCE_TIME_USE_DURATION;
    public static final ForgeConfigSpec.IntValue ARCHMAGIC_USE_DURATION;
    public static final ForgeConfigSpec.IntValue AREA_LIGHTNING_USE_DURATION;
    public static final ForgeConfigSpec.IntValue BEDROCK_WALL_USE_DURATION;
    public static final ForgeConfigSpec.IntValue BLINK_USE_DURATION;
    public static final ForgeConfigSpec.IntValue BREACH_USE_DURATION;
    public static final ForgeConfigSpec.IntValue CHANGE_WEATHER_USE_DURATION;
    public static final ForgeConfigSpec.IntValue CHAOS_USE_DURATION;
    public static final ForgeConfigSpec.IntValue COLD_BLAST_USE_DURATION;
    public static final ForgeConfigSpec.IntValue COLD_SHIELD_USE_DURATION;
    public static final ForgeConfigSpec.IntValue COLOR_SPRAY_USE_DURATION;
    public static final ForgeConfigSpec.IntValue COOKIE_CHEST_USE_DURATION;
    public static final ForgeConfigSpec.IntValue DIMENSION_DOOR_USE_DURATION;
    public static final ForgeConfigSpec.IntValue DISINTEGRATE_USE_DURATION;
    public static final ForgeConfigSpec.IntValue ELEMENTAL_FURY_USE_DURATION;
    public static final ForgeConfigSpec.IntValue FIREBALL_USE_DURATION;
    public static final ForgeConfigSpec.IntValue FIRE_SHIELD_USE_DURATION;
    public static final ForgeConfigSpec.IntValue FISH_FORM_USE_DURATION;
    public static final ForgeConfigSpec.IntValue FLAMING_HANDS_USE_DURATION;
    public static final ForgeConfigSpec.IntValue FLIGHT_USE_DURATION;
    public static final ForgeConfigSpec.IntValue GREATER_FIREBALL_USE_DURATION;
    public static final ForgeConfigSpec.IntValue HASTE_USE_DURATION;
    public static final ForgeConfigSpec.IntValue ICICLE_USE_DURATION;
    public static final ForgeConfigSpec.IntValue ICY_GRIP_USE_DURATION;
    public static final ForgeConfigSpec.IntValue INSTANT_LEVITATION_USE_DURATION;
    public static final ForgeConfigSpec.IntValue LIGHTNING_BOLT_USE_DURATION;
    public static final ForgeConfigSpec.IntValue LIGHTNING_SHIELD_USE_DURATION;
    public static final ForgeConfigSpec.IntValue MISCAST_MAGIC_USE_DURATION;
    public static final ForgeConfigSpec.IntValue OBSIDIAN_WALL_USE_DURATION;
    public static final ForgeConfigSpec.IntValue PANIC_ROOM_USE_DURATION;
    public static final ForgeConfigSpec.IntValue PUSH_USE_DURATION;
    public static final ForgeConfigSpec.IntValue SPELL_SHIELD_USE_DURATION;
    public static final ForgeConfigSpec.IntValue STONE_WALL_USE_DURATION;
    public static final ForgeConfigSpec.IntValue SUMMON_SKELETON_USE_DURATION;
    public static final ForgeConfigSpec.IntValue SUMMON_WITHER_SKELETON_USE_DURATION;
    public static final ForgeConfigSpec.IntValue SUMMON_WOLF_USE_DURATION;
    public static final ForgeConfigSpec.IntValue SURGE_SHIELD_USE_DURATION;
    public static final ForgeConfigSpec.IntValue TASER_USE_DURATION;
    public static final ForgeConfigSpec.IntValue TORCHLIGHT_USE_DURATION;
    public static final ForgeConfigSpec.IntValue WAIL_OF_THE_SHE_WOLF_USE_DURATION;
    public static final ForgeConfigSpec.IntValue ADVANCE_TIME_MIN;
    public static final ForgeConfigSpec.IntValue ADVANCE_TIME_MAX;
    public static final ForgeConfigSpec.IntValue ADVANCE_TIME_RANGE;
    public static final ForgeConfigSpec.IntValue ARCHMAGIC_DURATION;
    public static final ForgeConfigSpec.IntValue AREA_LIGHTNING_DAMAGE;
    public static final ForgeConfigSpec.IntValue AREA_LIGHTNING_DURATION;
    public static final ForgeConfigSpec.IntValue AREA_LIGHTNING_RANGE;
    public static final ForgeConfigSpec.IntValue BEDROCK_WALL_HORIZONTAL;
    public static final ForgeConfigSpec.IntValue BEDROCK_WALL_VERTICAL;
    public static final ForgeConfigSpec.IntValue BLINK_DURATION;
    public static final ForgeConfigSpec.IntValue BREACH_RANGE;
    public static final ForgeConfigSpec.IntValue CHANGE_WEATHER_MIN;
    public static final ForgeConfigSpec.IntValue CHANGE_WEATHER_MAX;
    public static final ForgeConfigSpec.IntValue CHAOS_DURATION;
    public static final ForgeConfigSpec.IntValue COLD_BLAST_RANGE;
    public static final ForgeConfigSpec.IntValue COLD_BLAST_DURATION;
    public static final ForgeConfigSpec.IntValue COLD_BLAST_DAMAGE;
    public static final ForgeConfigSpec.IntValue COLD_SHIELD_DURATION;
    public static final ForgeConfigSpec.IntValue COLOR_SPRAY_RANGE;
    public static final ForgeConfigSpec.IntValue COLOR_SPRAY_DURATION;
    public static final ForgeConfigSpec.IntValue DIMENSION_DOOR_MIN;
    public static final ForgeConfigSpec.IntValue DIMENSION_DOOR_MAX;
    public static final ForgeConfigSpec.IntValue DISINTEGRATE_DURATION;
    public static final ForgeConfigSpec.IntValue DISINTEGRATE_DAMAGE;
    public static final ForgeConfigSpec.IntValue ELEMENTAL_FURY_HORIZONTAL;
    public static final ForgeConfigSpec.IntValue FIREBALL_DAMAGE;
    public static final ForgeConfigSpec.IntValue FIRE_SHIELD_DURATION;
    public static final ForgeConfigSpec.IntValue FISH_FORM_DURATION;
    public static final ForgeConfigSpec.IntValue FLAMING_HANDS_DAMAGE;
    public static final ForgeConfigSpec.IntValue FLAMING_HANDS_RANGE;
    public static final ForgeConfigSpec.IntValue FLIGHT_DURATION;
    public static final ForgeConfigSpec.IntValue GREATER_FIREBALL_DAMAGE;
    public static final ForgeConfigSpec.IntValue HASTE_DURATION;
    public static final ForgeConfigSpec.IntValue ICICLE_RANGE;
    public static final ForgeConfigSpec.IntValue ICICLE_DURATION;
    public static final ForgeConfigSpec.IntValue ICICLE_DAMAGE;
    public static final ForgeConfigSpec.IntValue ICY_GRIP_RANGE;
    public static final ForgeConfigSpec.IntValue ICY_GRIP_DURATION;
    public static final ForgeConfigSpec.IntValue ICY_GRIP_DAMAGE;
    public static final ForgeConfigSpec.IntValue INSTANT_LEVITATION_RANGE;
    public static final ForgeConfigSpec.IntValue LIGHTNING_BOLT_DAMAGE;
    public static final ForgeConfigSpec.IntValue LIGHTNING_BOLT_DURATION;
    public static final ForgeConfigSpec.IntValue LIGHTNING_SHIELD_DURATION;
    public static final ForgeConfigSpec.IntValue MISCAST_MAGIC_DURATION;
    public static final ForgeConfigSpec.IntValue OBSIDIAN_WALL_HORIZONTAL;
    public static final ForgeConfigSpec.IntValue OBSIDIAN_WALL_VERTICAL;
    public static final ForgeConfigSpec.IntValue PUSH_RANGE;
    public static final ForgeConfigSpec.IntValue PUSH_DAMAGE;
    public static final ForgeConfigSpec.IntValue PUSH_STRENGTH;
    public static final ForgeConfigSpec.IntValue SPELL_SHIELD_DURATION;
    public static final ForgeConfigSpec.IntValue STONE_WALL_HORIZONTAL;
    public static final ForgeConfigSpec.IntValue STONE_WALL_VERTICAL;
    public static final ForgeConfigSpec.IntValue SURGE_SHIELD_DURATION;
    public static final ForgeConfigSpec.IntValue TASER_DURATION;
    public static final ForgeConfigSpec.IntValue TASER_DAMAGE;
    public static final ForgeConfigSpec.IntValue WAIL_OF_THE_SHE_WOLF_RANGE;
    public static final ForgeConfigSpec.IntValue WAIL_OF_THE_SHE_WOLF_DAMAGE;
    public static final ForgeConfigSpec.IntValue SURGE_CHANCE;
    public static final ForgeConfigSpec.IntValue SURGE_CHAOS_CHANCE;
    public static final ForgeConfigSpec.IntValue SURGE_FIRE;
    public static final ForgeConfigSpec.BooleanValue SURGE_POTION;
    ...
    public static final ArrayList<MobEffectInstance> SURGE_EFFECTS = new ArrayList<>();
    ...
    static {
        ...
        pop();
        push("surge");
        SURGE_CHANCE = defineInt("The chance (1 in X) for surges to occur. Set to 0 to disable surges entirely.", "chance", 200, 0, 1000000);
        SURGE_CHAOS_CHANCE = defineInt("The chance (1 in X) for surges to occur when the Chaos effect is active. Set to 0 to disable surges when the Chaos effect is active.", "chaos_chance", 2, 0, 1000000);
        SURGE_FIRE = defineInt("How long the fire surge sets you on fire. Set to 0 to disable.", "fire", 10, 0, 1000);
