...
public final class ItemInit implements IInit {
    ...
    public static final RegistryObject<Item> COLD_SHIELD = ITEMS.register("cold_shield", () -> new PotionSpell(Config.COLD_SHIELD_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.cold_shield, Config.COLD_SHIELD_DURATION.get())));
    ...
    public static final RegistryObject<Item> FIRE_SHIELD = ITEMS.register("fire_shield", () -> new PotionSpell(Config.FIRE_SHIELD_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.fire_shield, Config.FIRE_SHIELD_DURATION.get())));
    ...
    public static final RegistryObject<Item> LIGHTNING_SHIELD = ITEMS.register("lightning_shield", () -> new PotionSpell(Config.LIGHTNING_SHIELD_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.lightning_shield, Config.LIGHTNING_SHIELD_DURATION.get())));
    ...
    public static final RegistryObject<Item> SURGE_SHIELD = ITEMS.register("surge_shield", () -> new PotionSpell(Config.SURGE_SHIELD_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.surge_shield, Config.SURGE_SHIELD_DURATION.get())));
    public static final RegistryObject<Item> SPELL_SHIELD = ITEMS.register("spell_shield", () -> new PotionSpell(Config.SPELL_SHIELD_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.spell_shield, Config.SPELL_SHIELD_DURATION.get())));
    public static final RegistryObject<Item> ARCHMAGIC = ITEMS.register("archmagic", () -> new PotionSpell(Config.ARCHMAGIC_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.archmagic, Config.ARCHMAGIC_DURATION.get())));
    ...
    public static final RegistryObject<Item> CHAOS = ITEMS.register("chaos", () -> new PotionSpell(Config.CHAOS_USE_DURATION, Spell.Type.TARGET, new EffectInstance(EffectInit.chaos, Config.CHAOS_DURATION.get())));
    public static final RegistryObject<Item> MISCAST_MAGIC = ITEMS.register("miscast_magic", () -> new PotionSpell(Config.MISCAST_MAGIC_USE_DURATION, Spell.Type.TARGET, new EffectInstance(EffectInit.miscast_magic, Config.MISCAST_MAGIC_USE_DURATION.get())));
    ...
    public static final RegistryObject<Item> BLINK = ITEMS.register("blink", () -> new PotionSpell(Config.BLINK_USE_DURATION, Spell.Type.SELF, new EffectInstance(Effects.INVISIBILITY, Config.BLINK_DURATION.get())));
    ...
    public static final RegistryObject<Item> FISH_FORM = ITEMS.register("fish_form", () -> new PotionSpell(Config.FISH_FORM_USE_DURATION, Spell.Type.SELF, new EffectInstance(Effects.WATER_BREATHING, Config.FISH_FORM_DURATION.get())));
    public static final RegistryObject<Item> FLIGHT = ITEMS.register("flight", () -> new PotionSpell(Config.FLIGHT_USE_DURATION, Spell.Type.SELF, new EffectInstance(EffectInit.flight, Config.FLIGHT_DURATION.get())));
    public static final RegistryObject<Item> HASTE = ITEMS.register("haste", () -> new PotionSpell(Config.HASTE_USE_DURATION, Spell.Type.SELF, new EffectInstance(Effects.HASTE, Config.HASTE_DURATION.get())));
